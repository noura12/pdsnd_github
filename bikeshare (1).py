...
def get_filters():
    ...
    while True:
        ...
        city = input('Which city would you like to explore by? Enter chicago, new york city, or washington: ').lower()
    ...
    while True:
        ...
        month = input('''Which month would you like to explore by?  Enter 'all',
...
'january', 'february', 'march', 'april', 'may', or 'june': ''').lower()
    ...
    while True:
        ...
        day = input('''Which day of the week would you like to explore by?
